                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-header">
                            <h4 class="text-header">Add Kitchen Quantity</h4>
                        </div>

                        <div class="card-body">

                            <form action="store_add_kitchen_quantity.php?id=<?php echo $id?>" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-12 col-sm-12 col-md-12 col-lg-12">
                                        <label for="laundry_items">Add Kitchen Quantity</label>
                                        <input id="laundry_items" type="number" min="0" class="form-control" name="add_kitchen_quantity" required>
                                    </div>
