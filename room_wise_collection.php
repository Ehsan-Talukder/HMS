              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="text-center">Room wise Collection of <?php echo $hotel?></h4>
                  </div>
                  <div class="card-body">
                             ...
                             $sl=1;
                                    ...
                                    ?>
                                      <tr><a href="">
                                        ...
                                        <td> <a href="see_collection.php?room_number=<?php echo $row['room_number']?>" class="btn btn-icon btn-info custom_btn_info">See Collection</a></td></a>
                                      </tr>
                          <?php }}?>
