...
$id=$_GET['id'];
  ...
  echo  $kitchen_quantity = ($_REQUEST['deduct_kitchen_quantity']);
...
$available_item_quantity-=$kitchen_quantity;
...
$sql = "UPDATE  kitchen SET available_item_quantity='$available_item_quantity' WHERE id=$id";
