                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <form action="store_add_balance.php?id=<?php echo $id ?>" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-12 col-sm-12 col-md-12 col-lg-12">
                                        <label for="laundry_items">Adding Balance</label>
                                        <input id="laundry_items" type="text" class="form-control" name="add_balance" required>
                                    </div>
